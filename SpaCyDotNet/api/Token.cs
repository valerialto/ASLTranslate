...
namespace SpacyDotNet
{
    public class Token : IXmlSerializable
    {
        ...
        private string _ent_type;
        private object _morph;
        ...
        public string EntType
        {
            get
            {
                return Interop.GetString(_pyToken?.ent_type_, ref _ent_type);
            }
        }
        ...
        public object Morph
        {
            get
            {
                return Interop.GetObject(_pyToken?.morph, ref _morph);
            }
        }
